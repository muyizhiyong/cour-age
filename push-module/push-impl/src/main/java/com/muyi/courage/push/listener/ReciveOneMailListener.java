 ...
 */
public class ReciveOneMailListener {
    private MimeMessage mimeMessage = null;
    private String saveAttachPath = ""; //附件下载后的存放目录
    private StringBuffer bodytext = new StringBuffer();//存放邮件内容
    private String dateformat = "yy-MM-dd HH:mm"; //默认的日前显示格式

    public ReciveOneMailListener(MimeMessage mimeMessage) {
    ...
    public static void main(String args[]) throws Exception {
        ...
        URLName urln = new URLName("pop3", "pop3.163.com", 110, null,
                "muyi_zhiyong@163.com", "yzy587587YZY");
        ...
        for (int i = 0; i < message.length; i++) {
            System.out.println("======================");
            pmm = new ReciveOneMailListener((MimeMessage) message[i]);
